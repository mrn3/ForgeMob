...
$parcel$export(module.exports, "TabPanels", () => $f982e6cd1aac14a3$export$5dae8d435677f210);
...
function $f982e6cd1aac14a3$var$TabsInner({ props: props, tabsRef: ref, collection: collection }) {
    ...
    return /*#__PURE__*/ (0, ($parcel$interopDefault($ke4kY$react))).createElement((0, $c5ccf687772c0422$exports.dom).div, {
        ...(0, $ke4kY$reactaria.mergeProps)(DOMProps, renderProps, focusProps),
        ref: ref,
...
function $f982e6cd1aac14a3$var$TabListInner({ props: props, forwardedRef: ref }) {
    ...
    delete DOMProps.id;
    return /*#__PURE__*/ (0, ($parcel$interopDefault($ke4kY$react))).createElement((0, $c5ccf687772c0422$exports.dom).div, {
        ...(0, $ke4kY$reactaria.mergeProps)(DOMProps, renderProps, tabListProps),
        ref: objectRef,
        "data-orientation": orientation || undefined
    }, /*#__PURE__*/ (0, ($parcel$interopDefault($ke4kY$react))).createElement((0, $2d10bc562fea46b3$exports.SharedElementTransition), null, /*#__PURE__*/ (0, ($parcel$interopDefault($ke4kY$react))).createElement(CollectionRoot, {
        collection: state.collection,
        persistedKeys: (0, $3114c2382242bdc0$exports.usePersistedKeys)(state.selectionManager.focusedKey)
    })));
}
class $f982e6cd1aac14a3$var$TabItemNode extends (0, $ke4kY$reactariacollections.CollectionNode) {
}
$f982e6cd1aac14a3$var$TabItemNode.type = 'item';
const $f982e6cd1aac14a3$export$3e41faf802a29e71 = /*#__PURE__*/ (0, $ke4kY$reactariacollections.createLeafComponent)($f982e6cd1aac14a3$var$TabItemNode, (props, forwardedRef, item)=>{
    let state = (0, $ke4kY$react.useContext)($f982e6cd1aac14a3$export$364712098d2aa57c);
    ...
    let ElementType = item.props.href ? (0, $c5ccf687772c0422$exports.dom).a : (0, $c5ccf687772c0422$exports.dom).div;
    let DOMProps = (0, $ke4kY$reactariautils.filterDOMProps)(props, {
        global: true
    });
    delete DOMProps.id;
    ...
    return /*#__PURE__*/ (0, ($parcel$interopDefault($ke4kY$react))).createElement(ElementType, {
        ...(0, $ke4kY$reactaria.mergeProps)(DOMProps, renderProps, tabProps, focusProps, hoverProps),
        ref: ref,
    ...
    }, /*#__PURE__*/ (0, ($parcel$interopDefault($ke4kY$react))).createElement((0, $54e872c96e6d295b$exports.SelectionIndicatorContext).Provider, {
        value: {
            isSelected: isSelected
        }
    }, renderProps.children));
});
const $f982e6cd1aac14a3$export$5dae8d435677f210 = /*#__PURE__*/ (0, $ke4kY$reactariacollections.createHideableComponent)(function TabPanels(props, forwardedRef) {
    let state = (0, $ke4kY$react.useContext)($f982e6cd1aac14a3$export$364712098d2aa57c);
    let ref = (0, $ke4kY$reactariautils.useObjectRef)(forwardedRef);
    let selectedKeyRef = (0, $ke4kY$react.useRef)(state.selectedKey);
    let prevSize = (0, $ke4kY$react.useRef)(null);
    let hasTransition = (0, $ke4kY$react.useRef)(null);
    (0, $ke4kY$reactariautils.useLayoutEffect)(()=>{
        let el = ref.current;
        if (!el) return;
...
const $f982e6cd1aac14a3$export$3d96ec278d3efce4 = /*#__PURE__*/ (0, $ke4kY$reactariacollections.createHideableComponent)(function TabPanel(props, forwardedRef) {
    ...
    let [isInitiallySelected, setInitiallySelected] = (0, $ke4kY$react.useState)(state.selectedKey != null ? isSelected : null);
    ...
    let isExiting = (0, $ke4kY$reactariautils.useExitAnimation)(ref, isSelected);
    if (!isSelected && !props.shouldForceMount && !isExiting) return null;
    return /*#__PURE__*/ (0, ($parcel$interopDefault($ke4kY$react))).createElement($f982e6cd1aac14a3$var$TabPanelInner, {
        ...props,
        tabPanelRef: ref,
...
function $f982e6cd1aac14a3$var$TabPanelInner(props) {
    let state = (0, $ke4kY$react.useContext)($f982e6cd1aac14a3$export$364712098d2aa57c);
    ...
    let { focusProps: focusProps, isFocused: isFocused, isFocusVisible: isFocusVisible } = (0, $ke4kY$reactaria.useFocusRing)();
    let isSelected = state.selectedKey === props.id;
    let isEntering = (0, $ke4kY$reactariautils.useEnterAnimation)(ref) && !isInitiallySelected;
    let renderProps = (0, $c5ccf687772c0422$exports.useRenderProps)({
        ...props,
    ...
    let DOMProps = (0, $ke4kY$reactariautils.filterDOMProps)(otherProps, {
        global: true
    });
    delete DOMProps.id;
    let domProps = isSelected ? (0, $ke4kY$reactaria.mergeProps)(DOMProps, tabPanelProps, focusProps, renderProps) : (0, $ke4kY$reactaria.mergeProps)(DOMProps, renderProps);
    return /*#__PURE__*/ (0, ($parcel$interopDefault($ke4kY$react))).createElement((0, $c5ccf687772c0422$exports.dom).div, {
        ...domProps,
        ref: ref,
        "data-focused": isFocused || undefined,
        "data-focus-visible": isFocusVisible || undefined,
        // @ts-ignore
        inert: (0, $ke4kY$reactariautils.inertValue)(!isSelected || props.inert),
