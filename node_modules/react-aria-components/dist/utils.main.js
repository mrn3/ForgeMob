...
$parcel$export(module.exports, "dom", () => $c5ccf687772c0422$export$df3a06d6289f983e);
/*
...
function $c5ccf687772c0422$export$9d4c57ee4c6ffdd8(initialState = true) {
    // Initial state is typically based on the parent having an aria-label or aria-labelledby.
    // If it does, this value should be false so that we don't update the state and cause a rerender when we go through the layoutEffect
    let [hasSlot, setHasSlot] = (0, $1nknz$react.useState)(initialState);
...
function $c5ccf687772c0422$var$DOMElement(ElementType, props, forwardedRef) {
    let { render: render, ...otherProps } = props;
    let elementRef = (0, $1nknz$react.useRef)(null);
    let ref = (0, $1nknz$react.useMemo)(()=>(0, $1nknz$reactariautils.mergeRefs)(forwardedRef, elementRef), [
        forwardedRef,
        elementRef
    ]);
    (0, $1nknz$reactariautils.useLayoutEffect)(()=>{
    ...
    return /*#__PURE__*/ (0, ($parcel$interopDefault($1nknz$react))).createElement(ElementType, domProps);
}
const $c5ccf687772c0422$var$domComponentCache = {};
const $c5ccf687772c0422$export$df3a06d6289f983e = new Proxy({}, {
    get (target, elementType) {
        if (typeof elementType !== 'string') return undefined;
        let res = $c5ccf687772c0422$var$domComponentCache[elementType];
        if (!res) {
            res = /*#__PURE__*/ (0, $1nknz$react.forwardRef)($c5ccf687772c0422$var$DOMElement.bind(null, elementType));
            $c5ccf687772c0422$var$domComponentCache[elementType] = res;
        }
        return res;
    }
});
