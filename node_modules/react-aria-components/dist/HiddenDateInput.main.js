var $bChuM$internationalizeddate = require("@internationalized/date");
var $bChuM$react = require("react");
var $bChuM$reactaria = require("react-aria");
...
$parcel$export(module.exports, "HiddenDateInput", () => $7753596769f21492$export$eefa3e19139f00f3);
/*
...
const $7753596769f21492$var$dateSegments = [
    'day',
    'month',
    'year'
];
const $7753596769f21492$var$granularityMap = {
    'hour': 1,
    'minute': 2,
    'second': 3
};
function $7753596769f21492$export$f6a685cd1acbd1fa(props, state) {
    let { autoComplete: autoComplete, isDisabled: isDisabled, name: name } = props;
    let { visuallyHiddenProps: visuallyHiddenProps } = (0, $bChuM$reactaria.useVisuallyHidden)({
        style: {
    ...
    let dateValue = '';
    if (state.value) {
        if (state.granularity === 'day') dateValue = (0, $bChuM$internationalizeddate.toCalendarDate)(state.value).toString();
        else dateValue = (0, $bChuM$internationalizeddate.toCalendarDateTime)('timeZone' in state.value ? (0, $bChuM$internationalizeddate.toLocalTimeZone)(state.value) : state.value).toString();
    }
    ...
    if (timeSegments.includes(state.granularity)) {
        end = $7753596769f21492$var$granularityMap[state.granularity];
    ...
    return {
        ...
        inputProps: {
            ...
            onChange: (e)=>{
                ...
                if (targetString) try {
                    let targetValue = (0, $bChuM$internationalizeddate.parseDateTime)(targetString);
...
function $7753596769f21492$export$eefa3e19139f00f3(props) {
    let { state: state } = props;
    let { containerProps: containerProps, inputProps: inputProps } = $7753596769f21492$export$f6a685cd1acbd1fa({
        ...props
    }, state);
    return /*#__PURE__*/ (0, ($parcel$interopDefault($bChuM$react))).createElement("div", {
        ...containerProps,
        "data-testid": "hidden-dateinput-container"
    }, /*#__PURE__*/ (0, ($parcel$interopDefault($bChuM$react))).createElement("input", inputProps));
}


//# sourceMappingURL=HiddenDateInput.main.js.map
