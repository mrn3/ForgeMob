...
let $1910c06f0ca9905e$var$TableElementType = /*#__PURE__*/ (0, $dbSRa$forwardRef)(function TableElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, $dbSRa$useContext)((0, $7135fc7d473fd974$export$4feb769f8ddf26c5));
    if (isVirtualized) return /*#__PURE__*/ (0, $dbSRa$react).createElement((0, $64fa3d84918910a7$export$df3a06d6289f983e).div, {
        ...props,
        ref: ref
    });
    return /*#__PURE__*/ (0, $dbSRa$react).createElement((0, $64fa3d84918910a7$export$df3a06d6289f983e).table, {
        ...props,
        ref: ref
    });
});
function $1910c06f0ca9905e$var$TableInner({ props: props, forwardedRef: ref, selectionState: selectionState, collection: collection }) {
    ...
    }, /*#__PURE__*/ (0, $dbSRa$react).createElement((0, $dbSRa$FocusScope), null, /*#__PURE__*/ (0, $dbSRa$react).createElement($1910c06f0ca9905e$var$TableElementType, {
...
let $1910c06f0ca9905e$var$THeadElementType = /*#__PURE__*/ (0, $dbSRa$forwardRef)(function THeadElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, $dbSRa$useContext)((0, $7135fc7d473fd974$export$4feb769f8ddf26c5));
    if (isVirtualized) return /*#__PURE__*/ (0, $dbSRa$react).createElement((0, $64fa3d84918910a7$export$df3a06d6289f983e).div, {
        ...props,
        ref: ref
    });
    return /*#__PURE__*/ (0, $dbSRa$react).createElement((0, $64fa3d84918910a7$export$df3a06d6289f983e).thead, {
        ...props,
        ref: ref
    });
});
const $1910c06f0ca9905e$export$f850895b287ef28e = /*#__PURE__*/ (0, $dbSRa$createBranchComponent)($1910c06f0ca9905e$var$TableHeaderNode, (props, ref)=>{
    ...
    return /*#__PURE__*/ (0, $dbSRa$react).createElement($1910c06f0ca9905e$var$THeadElementType, {
...
let $1910c06f0ca9905e$var$TableHeaderRowElementType = /*#__PURE__*/ (0, $dbSRa$forwardRef)(function TableHeaderRowElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, $dbSRa$useContext)((0, $7135fc7d473fd974$export$4feb769f8ddf26c5));
    if (isVirtualized) return /*#__PURE__*/ (0, $dbSRa$react).createElement("div", {
        ...props,
        ref: ref
    });
...
function $1910c06f0ca9905e$var$TableHeaderRow({ item: item }) {
    ...
    return /*#__PURE__*/ (0, $dbSRa$react).createElement($1910c06f0ca9905e$var$TableHeaderRowElementType, {
        ...rowProps,
        ref: ref
...
let $1910c06f0ca9905e$var$ColumnElementType = /*#__PURE__*/ (0, $dbSRa$forwardRef)(function ColumnElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, $dbSRa$useContext)((0, $7135fc7d473fd974$export$4feb769f8ddf26c5));
    if (isVirtualized) return /*#__PURE__*/ (0, $dbSRa$react).createElement((0, $64fa3d84918910a7$export$df3a06d6289f983e).div, {
        ...props,
        ref: ref
    });
    return /*#__PURE__*/ (0, $dbSRa$react).createElement((0, $64fa3d84918910a7$export$df3a06d6289f983e).th, {
        ...props,
        ref: ref
    });
});
const $1910c06f0ca9905e$export$816b5d811295e6bc = /*#__PURE__*/ (0, $dbSRa$createLeafComponent)($1910c06f0ca9905e$var$TableColumnNode, (props, forwardedRef, column)=>{
    ...
    let state = (0, $dbSRa$useContext)($1910c06f0ca9905e$export$38de1cb0526c21fb);
    let { isVirtualized: isVirtualized } = (0, $dbSRa$useContext)((0, $7135fc7d473fd974$export$4feb769f8ddf26c5));
    let { columnHeaderProps: columnHeaderProps, isPressed: isPressed } = (0, $dbSRa$useTableColumnHeader)({
        node: column,
        isVirtualized: isVirtualized
    }, state, ref);
    ...
    delete DOMProps.id;
    return /*#__PURE__*/ (0, $dbSRa$react).createElement($1910c06f0ca9905e$var$ColumnElementType, {
...
let $1910c06f0ca9905e$var$TableBodyElementType = /*#__PURE__*/ (0, $dbSRa$forwardRef)(function TableBodyElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, $dbSRa$useContext)((0, $7135fc7d473fd974$export$4feb769f8ddf26c5));
    if (isVirtualized) return /*#__PURE__*/ (0, $dbSRa$react).createElement((0, $64fa3d84918910a7$export$df3a06d6289f983e).div, {
        ...props,
        ref: ref
    });
    return /*#__PURE__*/ (0, $dbSRa$react).createElement((0, $64fa3d84918910a7$export$df3a06d6289f983e).tbody, {
        ...props,
        ref: ref
    });
});
const $1910c06f0ca9905e$export$76ccd210b9029917 = /*#__PURE__*/ (0, $dbSRa$createBranchComponent)($1910c06f0ca9905e$var$TableBodyNode, (props, ref)=>{
    ...
    if (isEmpty && props.renderEmptyState && state) {
        ...
        emptyState = /*#__PURE__*/ (0, $dbSRa$react).createElement($1910c06f0ca9905e$var$TableRowElementType, {
            role: "row",
            ...rowProps,
            style: style
        }, /*#__PURE__*/ (0, $dbSRa$react).createElement($1910c06f0ca9905e$var$TableCellElementType, {
            role: "rowheader",
            ...rowHeaderProps,
            style: style
    ...
    return /*#__PURE__*/ (0, $dbSRa$react).createElement($1910c06f0ca9905e$var$TableBodyElementType, {
...
let $1910c06f0ca9905e$var$TableRowElementType = /*#__PURE__*/ (0, $dbSRa$forwardRef)(function TableRowElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, $dbSRa$useContext)((0, $7135fc7d473fd974$export$4feb769f8ddf26c5));
    if (isVirtualized) return /*#__PURE__*/ (0, $dbSRa$react).createElement((0, $64fa3d84918910a7$export$df3a06d6289f983e).div, {
        ...props,
        ref: ref
    });
    return /*#__PURE__*/ (0, $dbSRa$react).createElement((0, $64fa3d84918910a7$export$df3a06d6289f983e).tr, {
        ...props,
        ref: ref
    });
});
const $1910c06f0ca9905e$export$b59bdbef9ce70de2 = /*#__PURE__*/ (0, $dbSRa$createBranchComponent)($1910c06f0ca9905e$var$TableRowNode, (props, forwardedRef, item)=>{
    ...
    return /*#__PURE__*/ (0, $dbSRa$react).createElement((0, $dbSRa$react).Fragment, null, dropIndicator && !dropIndicator.isHidden && /*#__PURE__*/ (0, $dbSRa$react).createElement($1910c06f0ca9905e$var$TableRowElementType, {
        role: "row",
        style: {
            height: 0
        }
    ...
    }))), /*#__PURE__*/ (0, $dbSRa$react).createElement($1910c06f0ca9905e$var$TableRowElementType, {
...
let $1910c06f0ca9905e$var$TableCellElementType = /*#__PURE__*/ (0, $dbSRa$forwardRef)(function TableCellElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, $dbSRa$useContext)((0, $7135fc7d473fd974$export$4feb769f8ddf26c5));
    if (isVirtualized) return /*#__PURE__*/ (0, $dbSRa$react).createElement((0, $64fa3d84918910a7$export$df3a06d6289f983e).div, {
        ...props,
        ref: ref
    });
    return /*#__PURE__*/ (0, $dbSRa$react).createElement((0, $64fa3d84918910a7$export$df3a06d6289f983e).td, {
        ...props,
        ref: ref
    });
});
const $1910c06f0ca9905e$export$f6f0c3fe4ec306ea = /*#__PURE__*/ (0, $dbSRa$createLeafComponent)($1910c06f0ca9905e$var$TableCellNode, (props, forwardedRef, cell)=>{
    ...
    delete DOMProps.id;
    return /*#__PURE__*/ (0, $dbSRa$react).createElement($1910c06f0ca9905e$var$TableCellElementType, {
...
let $1910c06f0ca9905e$var$TableDropIndicatorRowElementType = /*#__PURE__*/ (0, $dbSRa$forwardRef)(function TableDropIndicatorRowElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, $dbSRa$useContext)((0, $7135fc7d473fd974$export$4feb769f8ddf26c5));
    if (isVirtualized) return /*#__PURE__*/ (0, $dbSRa$react).createElement((0, $64fa3d84918910a7$export$df3a06d6289f983e).div, {
        ...props,
        ref: ref
...
let $1910c06f0ca9905e$var$TableDropIndicatorTDElementType = /*#__PURE__*/ (0, $dbSRa$forwardRef)(function TableDropIndicatorTDElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, $dbSRa$useContext)((0, $7135fc7d473fd974$export$4feb769f8ddf26c5));
    if (isVirtualized) return /*#__PURE__*/ (0, $dbSRa$react).createElement((0, $64fa3d84918910a7$export$df3a06d6289f983e).div, {
        ...props,
        ref: ref
...
function $1910c06f0ca9905e$var$TableDropIndicator(props, ref) {
    ...
    return /*#__PURE__*/ (0, $dbSRa$react).createElement($1910c06f0ca9905e$var$TableDropIndicatorRowElementType, {
        ...(0, $dbSRa$filterDOMProps)(props, {
            global: true
        }),
        ...renderProps,
    ...
    }, /*#__PURE__*/ (0, $dbSRa$react).createElement($1910c06f0ca9905e$var$TableDropIndicatorTDElementType, {
        role: "gridcell",
        colSpan: state.collection.columnCount,
        style: {
            padding: 0
...
function $1910c06f0ca9905e$var$RootDropIndicator() {
    ...
    return /*#__PURE__*/ (0, $dbSRa$react).createElement($1910c06f0ca9905e$var$TableRowElementType, {
        role: "row",
...
const $1910c06f0ca9905e$export$8f5bea0338ed243c = (0, $dbSRa$createLeafComponent)((0, $dbSRa$LoaderNode), function TableLoadingIndicator(props, ref, item) {
    ...
    let sentinelRef = (0, $dbSRa$useRef)(null);
    let memoedLoadMoreProps = (0, $dbSRa$useMemo)(()=>({
    ...
    return /*#__PURE__*/ (0, $dbSRa$react).createElement((0, $dbSRa$react).Fragment, null, /*#__PURE__*/ (0, $dbSRa$react).createElement($1910c06f0ca9905e$var$TableRowElementType, {
        style: {
            height: 0
        },
        inert: (0, $dbSRa$inertValue)(true)
    }, /*#__PURE__*/ (0, $dbSRa$react).createElement($1910c06f0ca9905e$var$TableCellElementType, {
        style: {
            padding: 0,
            border: 0
    ...
    }))), isLoading && renderProps.children && /*#__PURE__*/ (0, $dbSRa$react).createElement($1910c06f0ca9905e$var$TableRowElementType, {
        ...(0, $dbSRa$mergeProps)((0, $dbSRa$filterDOMProps)(props, {
            global: true
        }), rowProps),
        ...renderProps,
