...
class $37b9a5d4bd0d4ded$var$TableCollection extends (0, $5VUTk$reactariacollections.BaseCollection) {
    ...
    *[Symbol.iterator]() {
    ...
    constructor(...args){
        super(...args), this.headerRows = [], this.columns = [], this.rows = [], this.rowHeaderColumnKeys = new Set(), this.head = new $37b9a5d4bd0d4ded$var$TableHeaderNode(-1), this.body = new $37b9a5d4bd0d4ded$var$TableBodyNode(-2), this.columnsDirty = true;
    }
}
...
const $37b9a5d4bd0d4ded$export$7063e69b8a954175 = /*#__PURE__*/ (0, $5VUTk$react.forwardRef)(function ResizableTableContainer(props, ref) {
    ...
    return /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement((0, $c5ccf687772c0422$exports.dom).div, {
        render: props.render,
...
let $37b9a5d4bd0d4ded$var$TableElementType = /*#__PURE__*/ (0, $5VUTk$react.forwardRef)(function TableElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, $5VUTk$react.useContext)((0, $3114c2382242bdc0$exports.CollectionRendererContext));
    if (isVirtualized) return /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement((0, $c5ccf687772c0422$exports.dom).div, {
        ...props,
        ref: ref
    });
    return /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement((0, $c5ccf687772c0422$exports.dom).table, {
        ...props,
        ref: ref
    });
});
function $37b9a5d4bd0d4ded$var$TableInner({ props: props, forwardedRef: ref, selectionState: selectionState, collection: collection }) {
    ...
    let filteredState = (0, $5VUTk$reactstately.UNSTABLE_useFilteredTableState)(tableState, filter);
    ...
    }, /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement((0, $5VUTk$reactaria.FocusScope), null, /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement($37b9a5d4bd0d4ded$var$TableElementType, {
...
class $37b9a5d4bd0d4ded$var$TableHeaderNode extends (0, $5VUTk$reactariacollections.CollectionNode) {
}
$37b9a5d4bd0d4ded$var$TableHeaderNode.type = 'tableheader';
let $37b9a5d4bd0d4ded$var$THeadElementType = /*#__PURE__*/ (0, $5VUTk$react.forwardRef)(function THeadElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, $5VUTk$react.useContext)((0, $3114c2382242bdc0$exports.CollectionRendererContext));
    if (isVirtualized) return /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement((0, $c5ccf687772c0422$exports.dom).div, {
        ...props,
        ref: ref
    });
    return /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement((0, $c5ccf687772c0422$exports.dom).thead, {
        ...props,
        ref: ref
    });
});
const $37b9a5d4bd0d4ded$export$f850895b287ef28e = /*#__PURE__*/ (0, $5VUTk$reactariacollections.createBranchComponent)($37b9a5d4bd0d4ded$var$TableHeaderNode, (props, ref)=>{
    ...
    return /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement($37b9a5d4bd0d4ded$var$THeadElementType, {
...
let $37b9a5d4bd0d4ded$var$TableHeaderRowElementType = /*#__PURE__*/ (0, $5VUTk$react.forwardRef)(function TableHeaderRowElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, $5VUTk$react.useContext)((0, $3114c2382242bdc0$exports.CollectionRendererContext));
    if (isVirtualized) return /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement("div", {
        ...props,
        ref: ref
    });
...
function $37b9a5d4bd0d4ded$var$TableHeaderRow({ item: item }) {
    ...
    return /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement($37b9a5d4bd0d4ded$var$TableHeaderRowElementType, {
        ...rowProps,
        ref: ref
...
class $37b9a5d4bd0d4ded$var$TableColumnNode extends (0, $5VUTk$reactariacollections.CollectionNode) {
}
$37b9a5d4bd0d4ded$var$TableColumnNode.type = 'column';
let $37b9a5d4bd0d4ded$var$ColumnElementType = /*#__PURE__*/ (0, $5VUTk$react.forwardRef)(function ColumnElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, $5VUTk$react.useContext)((0, $3114c2382242bdc0$exports.CollectionRendererContext));
    if (isVirtualized) return /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement((0, $c5ccf687772c0422$exports.dom).div, {
        ...props,
        ref: ref
    });
    return /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement((0, $c5ccf687772c0422$exports.dom).th, {
        ...props,
        ref: ref
    });
});
const $37b9a5d4bd0d4ded$export$816b5d811295e6bc = /*#__PURE__*/ (0, $5VUTk$reactariacollections.createLeafComponent)($37b9a5d4bd0d4ded$var$TableColumnNode, (props, forwardedRef, column)=>{
    var _state_sortDescriptor, _state_sortDescriptor1;
    let ref = (0, $5VUTk$reactariautils.useObjectRef)(forwardedRef);
    let state = (0, $5VUTk$react.useContext)($37b9a5d4bd0d4ded$export$38de1cb0526c21fb);
    let { isVirtualized: isVirtualized } = (0, $5VUTk$react.useContext)((0, $3114c2382242bdc0$exports.CollectionRendererContext));
    let { columnHeaderProps: columnHeaderProps, isPressed: isPressed } = (0, $5VUTk$reactaria.useTableColumnHeader)({
        node: column,
        isVirtualized: isVirtualized
    }, state, ref);
    ...
    delete DOMProps.id;
    return /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement($37b9a5d4bd0d4ded$var$ColumnElementType, {
...
class $37b9a5d4bd0d4ded$var$TableBodyNode extends (0, $5VUTk$reactariacollections.FilterableNode) {
}
$37b9a5d4bd0d4ded$var$TableBodyNode.type = 'tablebody';
let $37b9a5d4bd0d4ded$var$TableBodyElementType = /*#__PURE__*/ (0, $5VUTk$react.forwardRef)(function TableBodyElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, $5VUTk$react.useContext)((0, $3114c2382242bdc0$exports.CollectionRendererContext));
    if (isVirtualized) return /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement((0, $c5ccf687772c0422$exports.dom).div, {
        ...props,
        ref: ref
    });
    return /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement((0, $c5ccf687772c0422$exports.dom).tbody, {
        ...props,
        ref: ref
    });
});
const $37b9a5d4bd0d4ded$export$76ccd210b9029917 = /*#__PURE__*/ (0, $5VUTk$reactariacollections.createBranchComponent)($37b9a5d4bd0d4ded$var$TableBodyNode, (props, ref)=>{
    let state = (0, $5VUTk$react.useContext)($37b9a5d4bd0d4ded$export$38de1cb0526c21fb);
    let { isVirtualized: isVirtualized } = (0, $5VUTk$react.useContext)((0, $3114c2382242bdc0$exports.CollectionRendererContext));
    ...
    if (isEmpty && props.renderEmptyState && state) {
        ...
        emptyState = /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement($37b9a5d4bd0d4ded$var$TableRowElementType, {
            role: "row",
            ...rowProps,
            style: style
        }, /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement($37b9a5d4bd0d4ded$var$TableCellElementType, {
            role: "rowheader",
            ...rowHeaderProps,
            style: style
    ...
    return /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement($37b9a5d4bd0d4ded$var$TableBodyElementType, {
...
class $37b9a5d4bd0d4ded$var$TableRowNode extends (0, $5VUTk$reactariacollections.CollectionNode) {
...
$37b9a5d4bd0d4ded$var$TableRowNode.type = 'item';
let $37b9a5d4bd0d4ded$var$TableRowElementType = /*#__PURE__*/ (0, $5VUTk$react.forwardRef)(function TableRowElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, $5VUTk$react.useContext)((0, $3114c2382242bdc0$exports.CollectionRendererContext));
    if (isVirtualized) return /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement((0, $c5ccf687772c0422$exports.dom).div, {
        ...props,
        ref: ref
    });
    return /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement((0, $c5ccf687772c0422$exports.dom).tr, {
        ...props,
        ref: ref
    });
});
const $37b9a5d4bd0d4ded$export$b59bdbef9ce70de2 = /*#__PURE__*/ (0, $5VUTk$reactariacollections.createBranchComponent)($37b9a5d4bd0d4ded$var$TableRowNode, (props, forwardedRef, item)=>{
    let ref = (0, $5VUTk$reactariautils.useObjectRef)(forwardedRef);
    let state = (0, $5VUTk$react.useContext)($37b9a5d4bd0d4ded$export$38de1cb0526c21fb);
    ...
    return /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement((0, ($parcel$interopDefault($5VUTk$react))).Fragment, null, dropIndicator && !dropIndicator.isHidden && /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement($37b9a5d4bd0d4ded$var$TableRowElementType, {
        role: "row",
        style: {
            height: 0
        }
    ...
    }))), /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement($37b9a5d4bd0d4ded$var$TableRowElementType, {
...
class $37b9a5d4bd0d4ded$var$TableCellNode extends (0, $5VUTk$reactariacollections.CollectionNode) {
}
$37b9a5d4bd0d4ded$var$TableCellNode.type = 'cell';
let $37b9a5d4bd0d4ded$var$TableCellElementType = /*#__PURE__*/ (0, $5VUTk$react.forwardRef)(function TableCellElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, $5VUTk$react.useContext)((0, $3114c2382242bdc0$exports.CollectionRendererContext));
    if (isVirtualized) return /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement((0, $c5ccf687772c0422$exports.dom).div, {
        ...props,
        ref: ref
    });
    return /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement((0, $c5ccf687772c0422$exports.dom).td, {
        ...props,
        ref: ref
    });
});
const $37b9a5d4bd0d4ded$export$f6f0c3fe4ec306ea = /*#__PURE__*/ (0, $5VUTk$reactariacollections.createLeafComponent)($37b9a5d4bd0d4ded$var$TableCellNode, (props, forwardedRef, cell)=>{
    let ref = (0, $5VUTk$reactariautils.useObjectRef)(forwardedRef);
    let state = (0, $5VUTk$react.useContext)($37b9a5d4bd0d4ded$export$38de1cb0526c21fb);
    ...
    delete DOMProps.id;
    return /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement($37b9a5d4bd0d4ded$var$TableCellElementType, {
...
let $37b9a5d4bd0d4ded$var$TableDropIndicatorRowElementType = /*#__PURE__*/ (0, $5VUTk$react.forwardRef)(function TableDropIndicatorRowElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, $5VUTk$react.useContext)((0, $3114c2382242bdc0$exports.CollectionRendererContext));
    if (isVirtualized) return /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement((0, $c5ccf687772c0422$exports.dom).div, {
        ...props,
        ref: ref
...
let $37b9a5d4bd0d4ded$var$TableDropIndicatorTDElementType = /*#__PURE__*/ (0, $5VUTk$react.forwardRef)(function TableDropIndicatorTDElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, $5VUTk$react.useContext)((0, $3114c2382242bdc0$exports.CollectionRendererContext));
    if (isVirtualized) return /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement((0, $c5ccf687772c0422$exports.dom).div, {
        ...props,
        ref: ref
...
function $37b9a5d4bd0d4ded$var$TableDropIndicator(props, ref) {
    ...
    return /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement($37b9a5d4bd0d4ded$var$TableDropIndicatorRowElementType, {
        ...(0, $5VUTk$reactariautils.filterDOMProps)(props, {
            global: true
        }),
        ...renderProps,
    ...
    }, /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement($37b9a5d4bd0d4ded$var$TableDropIndicatorTDElementType, {
        role: "gridcell",
        colSpan: state.collection.columnCount,
        style: {
            padding: 0
...
function $37b9a5d4bd0d4ded$var$RootDropIndicator() {
    ...
    return /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement($37b9a5d4bd0d4ded$var$TableRowElementType, {
        role: "row",
...
const $37b9a5d4bd0d4ded$export$8f5bea0338ed243c = (0, $5VUTk$reactariacollections.createLeafComponent)((0, $5VUTk$reactariacollections.LoaderNode), function TableLoadingIndicator(props, ref, item) {
    let state = (0, $5VUTk$react.useContext)($37b9a5d4bd0d4ded$export$38de1cb0526c21fb);
    let { isVirtualized: isVirtualized } = (0, $5VUTk$react.useContext)((0, $3114c2382242bdc0$exports.CollectionRendererContext));
    ...
    let sentinelRef = (0, $5VUTk$react.useRef)(null);
    let memoedLoadMoreProps = (0, $5VUTk$react.useMemo)(()=>({
    ...
    return /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement((0, ($parcel$interopDefault($5VUTk$react))).Fragment, null, /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement($37b9a5d4bd0d4ded$var$TableRowElementType, {
        style: {
            height: 0
        },
        inert: (0, $5VUTk$reactariautils.inertValue)(true)
    }, /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement($37b9a5d4bd0d4ded$var$TableCellElementType, {
        style: {
            padding: 0,
            border: 0
    ...
    }))), isLoading && renderProps.children && /*#__PURE__*/ (0, ($parcel$interopDefault($5VUTk$react))).createElement($37b9a5d4bd0d4ded$var$TableRowElementType, {
        ...(0, $5VUTk$reactaria.mergeProps)((0, $5VUTk$reactariautils.filterDOMProps)(props, {
            global: true
        }), rowProps),
        ...renderProps,
