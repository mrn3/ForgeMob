...
import {endOfMonth as $d434x$endOfMonth} from "@internationalized/date";
...
function $faa2f3867773cfe5$export$26e2752316b9a375(props) {
    ...
    let { gridProps: gridProps, headerProps: headerProps, weekDays: weekDays, weeksInMonth: weeksInMonth } = (0, $d434x$useCalendarGrid)({
        ...props,
