...
function $ca3b77875a5017bc$export$18fc8428861184da(opts) {
    ...
    (0, $3WF3e$useEffect)(()=>{
        ...
        let onScroll = (e)=>{
            ...
            let onCloseHandler = onClose || $ca3b77875a5017bc$export$f6211563215e3b37.get(triggerRef.current);
...
export {$ca3b77875a5017bc$export$f6211563215e3b37 as onCloseMap, $ca3b77875a5017bc$export$18fc8428861184da as useCloseOnScroll};
